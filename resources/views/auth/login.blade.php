...
<body>
    ...
    <div class="d-md-flex half">
        <div class="bg"
            style="background-image: url('https://img.freepik.com/free-photo/portrait-sick-young-woman-resting-bed-medical-consultation-wearing-protective-face-mask-prevent-infection-with-coronavirus-recovering-after-surgery-hospital-ward-medicine-services_482257-29138.jpg?t=st=1720360231~exp=1720363831~hmac=b764c135c37717c973675809aea975c71c7b7d83be8d196d27fac57cd6958673&w=360');">
        </div>
        <div class="contents">
...
@endif -->
                                ...
                                <input type="submit" style="background: darkblue; border: 1px solid blue;"
