 <nav id="sidebar">
         ...
         <div class="sidebar-header">
             <div class="logo_section">
                 <a href="index.php"><img class="logo_icon img-responsive"
                         src="https://www.rccghealthcentre.com/assets/images/rccg-logo-121x121.png" alt="#" /></a>
             </div>
         </div>
         <div class="sidebar_user_info">
             ...
             <div class="user_profle_side">
                 <div class="user_img"><img class="img-responsive"
                         src="https://www.rccghealthcentre.com/assets/images/rccg-logo-121x121.png" alt="#" />
                 </div>
                 <div class="user_info">
     ...
     <div class="sidebar_blog_2">
         ...
         <ul class="list-unstyled components">
             <li class="active">
                 <a href="{{ url('dashboard') }}"><svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em"
                         viewBox="0 0 24 24">
             ...
             <li><a href="{{ url('ecounter') }}"><svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em"
                         viewBox="0 0 36 36">
                     ...
                     </svg> <span>My Medical Records </span></a></li>
             <li><a href="{{ url('pharmacy') }}">
                     ...
                     <span>My Prescription Records</span></a></li>
             <li><a href="{{ url('payments') }}">
                     ...
                     <span>Payment Records</span></a></li>
             <li class="active">
