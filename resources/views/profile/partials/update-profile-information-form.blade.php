                      ...
                      <div class="col-12 mt-3">
                        ...
                        <form method="post" action="{{ route('profile.update') }}" class="mt-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="full_name" name="full_name" value="{{ old('full_name', $user->full_name) }}" required autofocus autocomplete="full_name">
                                @error('full_name')
                            ...
                            <div class="mb-3">
                                <label for="state_of_residence" class="form-label">{{ __('State of Residence') }}</label>
                                <input type="text" class="form-control" id="state_of_residence" name="state_of_residence" value="{{ old('state_of_residence', $user->state_of_residence) }}" required autofocus autocomplete="state_of_residence">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth', $user->date_of_birth) }}" required autofocus autocomplete="date_of_birth">
                                @error('date_of_birth')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="phone_number" name="phone_number" value="{{ old('phone_number', $user->phone_number) }}" required autofocus autocomplete="phone_number">
                                @error('phone_number')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="home_address" name="home_address" value="{{ old('home_address', $user->home_address) }}" required autofocus autocomplete="home_address">
                                @error('home_address')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
