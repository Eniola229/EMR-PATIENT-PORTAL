                ...
                <div class="midde_cont">
                    <div class="container-fluid">
					   ...
					   <div class="col-12 mt-3">
					   	@if($pharmacys -> isNotEmpty())
					    @foreach($pharmacys as $pharmacys)
					    ...
					    <div class="row mt-4">
					        <div class="col-md-6">
					            <div class="card">
					                ...
					                <div class="card-body">
					                    <p><strong>Doctors Name:</strong> {{ $pharmacys->doctors_name }} </p>
					                    <p><strong>Doctors Email:</strong> <a href="#">{{ $pharmacys->doctors_email }} </a></p>
					                    <p><strong>Medical Officer:</strong> <a href="#">{{ $pharmacys->doctors_name }} </a></p></p>
					        ...
					        <div class="col-md-6">
					            <div class="card">
					                ...
					                <div class="card-body">
					                        <p><strong>Drugs:</strong> <a href="#">{{ $pharmacys->drugs }} </a></p>
					                    <p><strong>Doctors Comments:</strong> <a href="#">{{ $pharmacys->doctors_comments }} </a></p>
					                </div>
					            </div>
					        </div>
					    </div>
